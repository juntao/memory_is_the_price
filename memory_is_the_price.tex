...
A dedicated verification step re-fetched the price points that the
collection pass had flagged as outliers or inconsistencies within their
panels. Two extreme but genuine values were retained: DeepInfra's \$0.10/M
output loss-leader on Qwen3-235B-A22B, confirmed on DeepInfra's own price
page~\cite{r18}, and Cloudflare's \$2.25/M on Llama-3.3-70B. One duplicate
...
price), which left that panel below the three-provider threshold and removed
the model from the study. The same pass tested whether wide within-model spreads were explained
