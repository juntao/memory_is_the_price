...
$p = 1.9 \times 10^{-5}$). Market structure supports the scale reading in
part. The price floor of every 200B+ panel belongs to a vertically
integrated provider, never to a general-purpose cloud, and hyperscalers
price 1.2--8.8$\times$ above the floor. Participation, however, has
broadened as published expert-parallel serving recipes diffused, and MoE
price dispersion remains compressed. DeepSeek, whose vendor anchors its own
...
\textbf{H2 is partially supported.} Published deployments show a
...
Participation, however, no longer declines with footprint: trillion-scale
panels attract 11--22 providers, consistent with the diffusion of published
expert-parallel recipes. MoE price dispersion remains \emph{compressed}
