...
single-node deployment~\cite{lmsys,dzhsurf}. In all seven panels for models of 200B+
...
providers for a 117B-parameter model to three for a one-trillion-parameter
model. A corollary result is
